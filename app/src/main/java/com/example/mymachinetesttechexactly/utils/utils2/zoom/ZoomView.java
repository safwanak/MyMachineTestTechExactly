package com.example.mymachinetesttechexactly.utils.utils2.zoom;
    ...
    private void processSingleTouchOutsideMinimap(final MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                scrolling = false;
                DRAG=true;
                Log.d("spider", "here2:"+ "whwe" );
                //getParent().requestDisallowInterceptTouchEvent(true);
                break;

            case MotionEvent.ACTION_MOVE:
                if (scrolling || (smoothZoom > 1.0f && l > 30.0f && DRAG)) {
                    Log.d("spider", "here23467:" +scrolling + ":" + l/(zoom*zoom));
                    if (!scrolling) {
                        scrolling = true;
        ...
        Log.d("spider3", "here1:" +(zoomX-smoothZoomX));
        Log.d("spider3", "here2:" +(zoomY-smoothZoomY));
        Log.d("spider3", "here3:" +(zoom-smoothZoom));
